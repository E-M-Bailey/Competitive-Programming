...
//	uli ct1, ct0, f, l;
//
//	Entry(uli ct1, uli ct0, uli f, uli l) : ct1(ct1), ct0(ct0), f(f), l(l) {}
//};
...
void go()
{
	...
	loop(k, m, l)
	{
		...
		if (curVal * (ulli)bestL > bestVal * (ulli)l)
		{
			bestF = curF;
			bestVal = curVal;
			bestL = l;
	...
	//vpuli sections;
	//vbi::iterator first1 = find(ALL(S), true);
	//{
	//	vbi::iterator iter = first1;
	//	while (iter != S.end())
	//	{
	//		uli ct1 = 0, ct0 = 0;
