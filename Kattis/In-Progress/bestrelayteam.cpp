...
int main()
{
	...
	uli b1 = 0, b2 = 0, b3 = 0, b4 = 0;

	loop(0, n, i)
	{
		Runner& runner = r[i];
		float fa, fb;
		cin >> runner.name >> fa >> fb;
		runner.a = static_cast<uli>(fa * 100 + 0.5f);
		runner.b = static_cast<uli>(fb * 100 + 0.5f);
		...
		else if (runner.b < r[b2].b)
		{
			b4 = b3;
			b3 = b2;
			b2 = i;
		}
		else if (runner.b < r[b3].b)
		{
			b4 = b3;
			b3 = i;
		}
		else if (runner.b < r[b4].b)
		{
			b4 = i;
		}
	...
	loop(0, n, i)
	{
		...
		if (i == b1)
		{
			time += r[b2].b + r[b3].b + r[b4].b;
			d2 = b2;
			d3 = b3;
		}
		else if (i == b2)
		{
			time += r[b1].b + r[b3].b + r[b4].b;
		}
		else if (i == b3)
		{
			time += r[b1].b + r[b2].b + r[b4].b;
		}
		else
		{
			time += r[b1].b + r[b2].b + r[b3].b;
		}
		if (time < best)
			best = time;
	}
