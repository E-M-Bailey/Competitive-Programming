...
typedef unordered_multiset<bi>     msbi;
typedef unordered_multiset<ci>     msci;
typedef unordered_multiset<uci>    msuci;
typedef unordered_multiset<fci>    msfci;
typedef unordered_multiset<fuci>   msfuci;
typedef unordered_multiset<si>     mssi;
typedef unordered_multiset<usi>    msusi;
typedef unordered_multiset<fsi>    msfsi;
typedef unordered_multiset<fusi>   msfusi;
typedef unordered_multiset<li>     msli;
typedef unordered_multiset<uli>    msuli;
typedef unordered_multiset<fli>    msfli;
typedef unordered_multiset<fuli>   msfuli;
typedef unordered_multiset<lli>    mslli;
typedef unordered_multiset<ulli>   msulli;
typedef unordered_multiset<flli>   msflli;
typedef unordered_multiset<fulli>  msfulli;
typedef unordered_multiset<sf>     mssf;
typedef unordered_multiset<df>     msdf;
typedef unordered_multiset<ldf>    msldf;

typedef unordered_multiset<pbi>    mspbi;
typedef unordered_multiset<pci>    mspci;
typedef unordered_multiset<puci>   mspuci;
typedef unordered_multiset<pfci>   mspfci;
typedef unordered_multiset<pfuci>  mspfuci;
typedef unordered_multiset<psi>    mspsi;
typedef unordered_multiset<pusi>   mspusi;
typedef unordered_multiset<pfsi>   mspfsi;
typedef unordered_multiset<pfusi>  mspfusi;
typedef unordered_multiset<pli>    mspli;
typedef unordered_multiset<puli>   mspuli;
typedef unordered_multiset<pfli>   mspfli;
typedef unordered_multiset<pfuli>  mspfuli;
typedef unordered_multiset<plli>   msplli;
typedef unordered_multiset<pulli>  mspulli;
typedef unordered_multiset<pflli>  mspflli;
typedef unordered_multiset<pfulli> mspfulli;
typedef unordered_multiset<psf>    mspsf;
typedef unordered_multiset<pdf>    mspdf;
typedef unordered_multiset<pldf>   mspldf;
...
struct Edge
{
	uli v, u;
	ulli c, f;
	inline constexpr Edge(uli v, uli u, ulli c) : v(v), u(u), c(c), f(0) {}
};
...
int main()
{
	...
	while (true)
	{
		...
		while (!Q.empty())
		{
			...
			{
				Edge e = E[idx];
				// if edge is already full or already visited, continue
				if (e.c == e.f || L[e.u] < MAX(uli))
				{
					continue;
				}
				L[e.u] = L[v] + 1;
		...
		// if end isn't reachable, break
		if (L[f] == MAX(uli))
		{
			break;
		}

		fill(P.begin(), P.end(), MAX(uli));
