...
int main()
{
	...
	while (N > 2)
	{
		cout << N << " bottles of " << str << " on the wall, " << N << " bottles of " << str << '.' << endl;
		N--;
		cout << "Take one down, pass it around, " << N << " bottles of " << str << " on the wall." << endl << endl;
	}
	if (N == 2)
	{
		cout << "2 bottles of " << str << " on the wall, 2 bottles of " << str << '.' << endl;
		cout << "Take one down, pass it around, 1 bottle of " << str << " on the wall." << endl << endl;
	}
	cout << "1 bottle of " << str << " on the wall, 1 bottle of " << str << '.' << endl;
	cout << "Take it down, pass it around, no more bottles of " << str << '.';
